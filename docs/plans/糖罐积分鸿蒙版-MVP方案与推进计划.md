...
2026-08-29 S20c 不新增页面元素，只把“我的申请”完整刷新和加载更多收紧为严格排序、跨页身份唯一、快照单调与游标无循环；协议污染后保留已验证只读快照，但冻结继续分页和沿用旧规则创建申请。未决申请 intent 时“加载更多”不可用，仍无 operation reconcile、补充、取消或重新提交入口。
